...
var MBImport = (function () {
    ...
    function fnBuildSearchLink(release) {
        ...
        return `<a class="musicbrainz_import" href="//google.com/search?${url_params.join('&')}">Search on Bandcamp</a>`;
    }
    ...
    function fnSearchUrlFor(type, what) {
        ...
        return `//google.com/search?${params.join('&')}`;
    }

    /*
    //X compute HTML of import form
    ...
    //X build form POST parameters that MB is waiting
    ...
    //X Convert a list of artists to a list of artist credits with joinphrases
    ...
    //X Try to guess release type using number of tracks, title and total duration (in millisecs)
    ...
    //X convert HH:MM:SS or MM:SS to milliseconds
